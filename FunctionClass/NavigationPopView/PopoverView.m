...
-(CGRect)getViewFrame
{
    ...
    for (NSString *title in self.titleArray) {
        NSDictionary *attribute = @{NSFontAttributeName: TITLE_FONT};
        CGFloat width = [title boundingRectWithSize:CGSizeMake(300, 100) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading  attributes:attribute  context:nil].size.width;
